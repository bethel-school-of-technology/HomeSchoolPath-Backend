...
// blog-route list, listAllBlogsCategoriesTags, read, remove, update
...
exports.listAllBlogsCategoriesTags = (req, res) => {
  // have to use a post method to get access to the body
